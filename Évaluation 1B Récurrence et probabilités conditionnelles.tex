...
\begin{exercice}[Récurrence]~
  ...
  Démontrer par récurrence que $\forall n \in \N,\ 1 + 4 + 9 + \cdots +
  n = \dfrac{n(n+1)(2n+1)}6$
\end{exercice}

\begin{exercice}[Probabilités conditionnelles]~

  \begin{minipage}{0.75\linewidth}
    Le tableau ci-contre indique les résultats d'un sondage sur
    l'installation d'un parc d'horodateurs, auprès d'un échantillon de
    personnes fréquentant une ville.
  \end{minipage}
  \begin{minipage}{0.25\linewidth}
    \begin{tabular}{c|*{2}{c|}}
      \cline{2-3}
      & $H$ & $\overline{H}$ \\ \hline
      \multicolumn{1}{|c|}{$A$} & 125 & 175 \\
      \hline
      \multicolumn{1}{|c|}{$\overline{A}$} & 10 & 50 \\
      \hline
    \end{tabular}
  \end{minipage}

On choisit au hasard une personne de l'échantillon.
On considère les événements :
\begin{itemize}
  \item[$A$ :] « La personne a une opinion positive » ;
  \item[$H$ :] « La personne habite la ville ».
\end{itemize}
  \begin{enumerate}
    \item Calculer $P(A)$, $P(H)$, $P_A(H)$ et $P_H(A)$.
    \item Représenter la situation par un arbre :
      \begin{enumerate}
        \item en commençant par $A$ et $\overline{A}$ ;
        \item en commençant par $H$ et $\overline{H}$.
      \end{enumerate}
  \end{enumerate}
\end{exercice}
