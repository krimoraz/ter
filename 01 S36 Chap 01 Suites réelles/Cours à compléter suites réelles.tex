...
\framebox{\begin{minipage}{0.99\linewidth}
    \emph{Initialisation}\\[1.6cm]
    \emph{Hérédité}\\[4.8cm]
    \emph{Conclusion}\\[1.6cm]
  \end{minipage}
}
...
\framebox{
  \begin{minipage}{0.99\linewidth}
    \emph{Réécrire la proposition de la définition en terme
    d'appartenance à un intervalle.}
    \vspace{3cm}
  \end{minipage}
}
...
\framebox{
  \begin{minipage}{0.99\linewidth}
    $\lim_{n\to+\infty} u_n = \ell$ si et seulement si tout
    \underline{\hspace{5cm}} contenant \underline{\hspace{0.7cm}}
    contient aussi tous les termes de la suite \underline{\hspace{6cm}}.
  \end{minipage}
}
...
\framebox{
  \begin{minipage}{0.99\linewidth}
    ...
    \underline{\hspace{5cm}} de la forme \underline{\hspace{3cm}}
    contient aussi tous les termes de la suite \underline{\hspace{6cm}}.
  \end{minipage}
}
...
\framebox{
  \begin{minipage}{0.99\linewidth}
    \emph{Rappeler l'inégalité de Bernoulli :}
      \vspace{4cm}
  \end{minipage}
}
...
\framebox{
  \begin{minipage}{0.99\linewidth}
    \emph{Preuve :}
      ...
      $\ioo{-\frac{u_0}{\vabs{a}^{n_0+1}}}{\frac{u_0}{\vabs{a}^{n_0+1}}}$
