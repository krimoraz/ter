...
\begin{exercice}
  ...
  \begin{enumerate}
    \item Préciser son domaine de définition.
  \end{enumerate}
  ...
  \begin{enumerate}[resume]
    \item \begin{enumerate}
        \item Déterminer $\lim_{\substack{x\to1 \\ x>1}}f(x)$ et
          $\lim_{x\to+\infty}f(x).$
        \item En déduire que $\mathscr{C}$ admet deux asymptotes
          $\Delta_1$ et $\Delta_2$ dont on précisera les équations.
      \end{enumerate}
    \item \begin{enumerate}
...
\begin{exercice}
  ...
  \begin{enumerate} \itemÉtudier les variations de $f$ et en déduire
