...
chaîne de fabrication permet de modifier la valeur de $\sigma$.\index{loi
normale} 
...
= 750$ et d'écart-type $\sigma = 25$.\index{loi normale}
    ...
    \item 
      \begin{enumerate}
        ...
        \item De plus, on sait que dans ce pays les femmes représentent
          ...
          que cette personne soit une femme ?\hyperlink{Index}{*}
      \end{enumerate}
  \end{enumerate}
